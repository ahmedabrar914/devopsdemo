locals {
  vault_user_data_template_vars = {
    ...
    zotel_metadata_json_s3_uri    = var.zotel_metadata_json_s3_uri
    zotel_installer_name          = var.zotel_installer_name
    zotel_metadata_json_file_name = var.zotel_metadata_json_file_name
    ...
    zotel_siem_enabled            = var.zotel_siem_enabled
    zotel_siem_logs_endpoint      = var.zotel_siem_logs_endpoint
    zotel_siem_key                = var.zotel_siem_key
    zotel_siem_secret             = var.zotel_siem_secret
    ...
    vault_install_url                        = format("s3://%s/vault/%s/vault_%s_linux_amd64.zip", var.vault_artifact_bucket_name, var.vault_version, var.vault_version),
